    ...
    <div class="row">
        <div class="col-sm-6 col-sm-offset-3">
            <h3>
                ...
                <mark>Ticket</mark> Show In Date Range Created By <code><b>{{ Auth::user()->name }}</b></code>
            </h3>
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title text-center"><i class="fa fa-list-ul"></i> Date Wise <code><b>Ticket Show</b></code> Form</h3>
                </div>
                <div class="panel-body">

                    <h3>Ticket List Show</h3>
                    <hr>
                    <div class="row">
                        <div class="col-sm-12">
                            {!! Form::open([
                                    'url'         => 'ticket/created-by/ticket',
                                    'method'      => 'get',
                                    'role'        => 'form',
                                    'id'          => 'report-form',
